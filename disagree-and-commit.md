...
Backend Master orchestrator agent, an agent per expert on the panel. an agent to synthesizze the design recommendations and turn it into an impractical designed

AgentCore / Api Gateway Websocket / S3 / Strands / Gifs for Cartoon nova / aws panel people with NOva sonic /  Lottie for avatar animations